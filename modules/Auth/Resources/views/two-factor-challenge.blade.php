        ...
        <div class="">
            <div class="text-center mb-3">
                ...
                <p class="text-muted text-center mb-0">
                    {{ localize('Check Your Google Authenticator Application And Entering The
                                                            Authentication Code.') }}
                </p>
            </div>
            ...
            <form class="register-form validate" method="POST" action="{{ route('two-factor.login') }}">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active py-5 px-2" id="authenticator-code" role="tabpanel"
                        ...
                        <p class=" text-start">
                            {{ localize('Please confirm access to your account by entering the authentication code provided by
                    ...
                    <div class="tab-pane fade py-5 px-2" id="recovery-code" role="tabpanel"
                        ...
                        <p class=" text-start">
                            {{ localize('Please confirm access to your account by entering one of your emergency recovery
                                                                                    codes.') }}
                        </p>
                        <div class="mb-3">
                            <input type="text"
