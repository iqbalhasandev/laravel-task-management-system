<x-app-layout>
        ...
        <div class="my-2 text-center">
            <div>
                ...
                <button class="btn btn-success btn-sm mx-1" id="create-backup" onclick="createBackup()"><i
                        class="fa fa-plus-circle"></i>&nbsp;{{ localize('Create Backup Now') }} </button>
            </div>
            <div class="py-2">
    ...
    @push('modal')
        <x-modal id="create-backup-modal" :title="localize('New Backup Creating')" :close="false">
        ...
        <x-modal id="delete-backup-modal" :title="localize('Deleting Old Backup')" :close="false">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                style="margin: auto;  display: block;" width="100px" height="100px" viewBox="0 0 100 100"
                preserveAspectRatio="xMidYMid">
                <defs>
